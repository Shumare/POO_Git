...
namespace Interface2_1 {
	...
	/// <summary>
	/// Description résumée de Acity
	/// </summary>
	public ref class Acity : public System::Windows::Forms::Form
	{
	public:
		Acity(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &Acity::textBox1_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Acity::button1_Click);
			// 
			// Acity
			// 
